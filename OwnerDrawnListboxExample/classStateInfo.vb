...
Public Class classStateInfo
    ...
    Private m_stateFlag As Image = Nothing
    Private m_stateSeal As Image = Nothing
    ...
    <CategoryAttribute("Images"), _
      DescriptionAttribute("The state flag."), _
      DefaultValue(GetType(Image), "None"), _
      Editor(GetType(System.Drawing.Design.ImageEditor), GetType(UITypeEditor))> _
    Public Property stateFlag() As Image
        Get
            Return m_stateFlag
        End Get
    ...
    <CategoryAttribute("Images"), _
      DescriptionAttribute("The state seal."), _
      DefaultValue(GetType(Image), "None"), _
      Editor(GetType(System.Drawing.Design.ImageEditor), GetType(UITypeEditor))> _
    Public Property stateSeal() As Image
        Get
            Return m_stateSeal
        End Get
        Set(ByVal value As Image)
